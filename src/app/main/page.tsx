...
export default function HomePage() {
  return (
    <div>
      ...
      <div className="relative flex h-[900px] w-screen flex-col items-center justify-center md:h-[1075px]">
        {/* TODO: NEED A NEW IMAGE WITH REACHER ON RIGHT, NOT CENTERED FOR LARGER VIEWS */}
        <Image
          src="/reacher-images/reacher-2560x1440-06.jpg"
          className="h-auto max-w-[2560px] scale-x-[-1] transform object-cover object-center md:scale-x-100 md:object-left"
          alt="Reacher"
          fill={true}
          priority={true}
          unoptimized
      ...
      {/* SUMMARY SECTION */}
      {/* <div className="grid grid-rows-3 gap-6 p-6 text-black sm:grid-cols-3">
